...
Source: [Ministry of Education](https://www.moe.gov.sg/-/media/files/news/press/2017/annex-a---named-of-pri-and-sec-schools-merging-in-2019.pdf)

1.  Use the SecondarySchool layer, open attribute table and press ctrl+F

![](images/pic65.jpg)

2.  In the field of school_name, type 'East View Secondary' and click **Select Feature**. 

3.  Click **Toggle Editing** 

4.  Select the highlighted point which is East View Secondary school 

5.  Click the Delete Selected icon: ![](images/pic66.jpg) to remove the East View Secondary school\

![](images/pic67.jpg)

6.  Repeat the same step to remove the other merged schools 

7.  Save the rest of the school in the database and name it Secondary School_After merged 
